...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.button_wrong = Button(image=wrong_img, highlightthickness=0, command=self.true_click)
        self.button_wrong.grid(row=2, column=1)
        right_img = PhotoImage(file="./images/true.png")
        self.button_right = Button(image=right_img, highlightthickness=0, command=self.false_click)
